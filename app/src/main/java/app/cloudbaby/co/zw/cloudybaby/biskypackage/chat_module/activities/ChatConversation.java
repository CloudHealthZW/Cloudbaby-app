...
import app.cloudbaby.co.zw.cloudybaby.biskypackage.chat_module.events.PushNotificationEvent;
...
import app.cloudbaby.co.zw.cloudybaby.biskypackage.chat_module.model.MessageModel;
import app.cloudbaby.co.zw.cloudybaby.biskypackage.chat_module.viewholders.FirebaseMessageViewHolder;
...
import app.cloudbaby.co.zw.cloudybaby.biskypackage.utils.Utils;
import butterknife.BindView;
import butterknife.ButterKnife;

public class ChatConversation extends AppCompatActivity implements View.OnClickListener {
    ...
    private void initObjects() {
        mFirebaseHelper = FirebaseHelper.newInstance(this);
        mUtils = PreferencesUtils.getInstance(this);
        senderId = mUtils.getUserId();
        getDataFromBundle();
    ...
    private void getDataFromBundle() {
        ...
        if (bundle != null) {
            ...
            mReceiverToken = "" + bundle.getString("receiverToken");
            setTitle("" + reciverUserName);
        }
    }
    ...
    private void checkStatus() {
        ...
        DatabaseReference senderRefrence = database.getReference().child(Constants.CHAT_CONVERSATIONE_BADGE).child(senderId).child(reciverUid);
    ...
    private void sendMsg(String message, int type) {
        if (chat_id != null) {
            DatabaseReference chatMessageRefrence = database.getReference().child(Constants.CHAT_MESSAGE_BADGE).child(chat_id).push();
            ...
            //Reciver Refrence
            DatabaseReference reciverRefrence = database.getReference().child(Constants.CHAT_CONVERSATIONE_BADGE).child(reciverUid).child(senderId);
            ...
            // TODO Send a firebase notification at this point --- check back
            Log.e("ISSAMESSAGE", mReceiverToken);
            mFirebaseHelper.sendPushNotificationToReceiver(mUtils.getUserFirstName(), message, senderId, mUtils.getFirebaseToken(), mReceiverToken, chat_id);
            ...
            DatabaseReference chatIdRefrence = database.getReference().child(Constants.CHAT_MESSAGE_BADGE).push();
            ...
            chatUserModel.setFirebaseToken(mReceiverToken);
            ...
            chatUserModel.setFirebaseToken(mUtils.getFirebaseToken());
            chatUserModel.setDisplayName("" + mUtils.getUserFirstName() + " " + mUtils.getUserLastName());
            chatUserModel.setProfilePic("" + mUtils.profileImageLocation()); //TODO // FIXME: 7/2/2017  get a proper image URI here
            ...
            //TODO send a firebase cloud notification at this point
            Log.e("MESSAGESENT", mReceiverToken);
            mFirebaseHelper.sendPushNotificationToReceiver(mUtils.getUserFirstName(), message, senderId, mUtils.getFirebaseToken(), mReceiverToken, chat_id);
    ...
    private void setUpFirebaseAdapter() {
        ...
        Query recentPostsQuery = database.getReference().child(Constants.CHAT_MESSAGE_BADGE).child(chat_id)
    ...
    public void onPushNotificationEvent(PushNotificationEvent pushNotificationEvent) {
        //TODO checkback
        Toast.makeText(this, "Push Notification " + pushNotificationEvent.getFcmToken(), Toast.LENGTH_SHORT).show();
    }
...
//                    Log.d("Fbasecounterincrementfailed", "yes");
//                } else {
